...
| Source | Method |
|--------|--------|
| YouTube URL | `bun Tools/YouTubeTranscript.ts "URL"` to get transcript |
...
Obtain the full text/transcript. For YouTube, use `bun Tools/YouTubeTranscript.ts "URL"` to extract transcript (requires yt-dlp: `brew install yt-dlp`). Save to a working file if large.
